The Field Guide to Security Training in the |target_audience| v |release|
=========================================================================

{% if target_audience == "Campaign" %}
.. note::

   This fork of the original `Field Guide to Security Training in the
   Newsroom`_, which was written specifically for newsrooms, has been adapted and
   customized for use in the context of political campaigns. This was primarily
   done through substitution of the word "newsroom" with "campaign", but also
   by inclusion of campaign-specific content, and exclusion of newsroom- or
   journalism-specific content.

   Please contact the author (Dave Dittrich <dave.dittrich @ gmail.com>) to
   report any errors related to this customization.

.. _Field Guide to Security Training in the Newsroom: https://the-field-guide-to-security-training-in-the-newsroom.readthedocs.io/en/latest/
